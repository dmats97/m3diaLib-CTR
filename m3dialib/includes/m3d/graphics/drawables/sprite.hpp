...
namespace m3d {
  ...
  class Sprite: public Drawable {
    public:
      ...
      //animation
      int* m_animParam = NULL;
      int  m_animInterval = 0, m_animIndex = 0;
      ...
      void setPosition(int t_x, int t_y, int t_z);
      ...
      //change image from same spritesheet
      void setSpriteSheetIndex(int t_imageId);
      ...
      //Set Animation
      void Animate(int table[], int interval, bool loop);
    ...
    private:
      ...
      /* data */
      int m_posX, m_posY, m_posZ, m_centerX, m_centerY, m_opacity, m_index;
